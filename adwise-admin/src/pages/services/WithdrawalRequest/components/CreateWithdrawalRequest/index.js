...
const CreateWithdrawalRequest = (props) => {
    const {isOpen, onClose, onSubmit} = props;

    const [activeTab, setActiveTab] = useState('organization');
    const [form, setForm] = useState(initialFormOrganization);

    useEffect(() => {
        setForm(initialFormOrganization);
    ...
    return (
        ...
        >
            ...
            <DialogTitle>
                <Typography variant="h3">Создание запроса на вывод</Typography>
            </DialogTitle>
                        ...
                        <>
                            ...
                            <Box mb={2}>
                                ...
                                <Autocomplete
                                    ...
                                    fullWidth
                                    disableClearable
                                    getOptionLabel={(option) => `${ option.name } (${ formatMoney(option.wallet.points, 2, '.') } ${ currency[option.wallet.currency] })`}
