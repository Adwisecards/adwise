...
export class FindSubscriptionCreatedRecordsController extends HTTPController<FindSubscriptionCreatedRecordsDTO.Request, FindSubscriptionCreatedRecordsDTO.Response> {
    protected async executeImplementation(req: Request, res: Response) {
        const dto: FindSubscriptionCreatedRecordsDTO.Request = {
