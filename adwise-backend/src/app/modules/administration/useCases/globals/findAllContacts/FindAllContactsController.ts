...
export class FindAllContactsController extends HTTPController<FindAllContactsDTO.Request, FindAllContactsDTO.Response> {
    protected async executeImplementation(req: Request, res: Response) {
        const dto: FindAllContactsDTO.Request = {
