                ...
                items: [
                    {
                        ...
                        hint: 'нужно заполнить без указания правовой формы: ООО, ИП или СЗ в документах подставятся автоматически',
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        isGlobalDisabled: true,
                        validationSchema: Yup.string().min(13, 'Минимум 13 сомволов').max(13, 'Минимум 13 сомволов').required('Обязательно к заполнению')
                    },
                    {
                        name: "kpp",
                        title: 'КПП',
                        ...
                        type: 'number',
                        isGlobalDisabled: true,
                        validationSchema: Yup.string().min(9, 'Минимум 9 сомволов').max(9, 'Минимум 9 сомволов').required('Обязательно к заполнению')
                    },
                    {
                        name: "siteUrl",
                ...
                items: [
                    {
                        ...
                        placeholder: 'Россия',
                        type: 'select',
                        options: [{title: 'Россия', value: 'rus'}],
                        isGlobalDisabled: true,
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        type: 'date',
                        isGlobalDisabled: false,
                        validationSchema: Yup.string().nullable().matches(/^(0[1-9]|[12][0-9]|3[01])[.](0[1-9]|1[012])[.](19|20)/i, 'Запишите пожалуйста дату рождения в формате дд.мм.гггг')
                    },
                    {
        ...
        sections: [
            {
                ...
                items: [
                    ...
                    {
                        name: "founder.middleName",
                        title: 'Отчество учредителя',
                        placeholder: '***',
                        type: 'string'
                    },
                    {
                        name: "founder.address",
                        title: 'Адрес регистрации/адрес проживания учредителя',
                        placeholder: 'Екатеринбург, ул. Ленина д. 1 кв. 1',
                        type: 'address',
                        validationSchema: Yup.string().required('Обязательно к заполнению'),
                    },
                    {
                        name: "founder.dob",
                        title: 'Дата рождения учредителя',
                        placeholder: '01.01.2000',
                        type: 'date',
                        validationSchema: Yup
                            .string()
                    ...
                    {
                        name: "founder.pob",
                        title: 'Место рождения учредителя',
                        placeholder: 'Екатеринбург, ул. Ленина д. 1 кв. 1',
                        type: 'address'
                    },
                    {
                        name: "founder.citizenship",
                        title: 'Гражданство учредителя',
                        placeholder: '***',
                        type: 'string',
                        validationSchema: Yup.string().required('Обязательно к заполнению'),
                    },
                    {
                        notDisabled: true,
                        name: "founder.phone",
                        title: 'Контактный телефон учредителя',
                        placeholder: '***',
                        type: 'phone',
                        validationSchema: Yup.string().test(
                            "founder.phone",
            ...
            },
            {
                ...
                items: [
                    {
                        name: "founder.document.type",
                        title: 'Наименование документа, удостоверяющего личность',
                        placeholder: '***',
                        type: 'string'
                    },
                    {
                        name: "founder.document.issueDate",
                        title: 'Дата выдачи документа',
                        placeholder: '01.01.2020',
                        type: 'date',
                        isGlobalDisabled: false,
                    ...
                    {
                        name: "founder.document.issuedBy",
                        title: 'Кем выдан',
                        placeholder: 'Отделение ...',
                        type: 'string',
                        isGlobalDisabled: false,
                    ...
                    {
                        name: "founder.document.serialNumber",
                        title: 'Серия и номер документа',
                        placeholder: '1122 334455',
                        type: 'string',
                        isGlobalDisabled: false,
                    ...
                    {
                        name: "founder.document.departmentCode",
                        title: 'Код подразделения',
                        placeholder: '111-222',
                        type: 'string',
                        isGlobalDisabled: false,
