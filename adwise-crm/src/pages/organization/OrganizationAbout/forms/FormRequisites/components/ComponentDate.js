...
const ComponentDate = (props) => {
    const {title, name, value, placeholder, caption, onChange, disabled} = props;
    ...
    return (
        <>
            ...
            {(isError) && (<Typography className={classes.caption} style={{ color: '#e53935' }}>{props.helperText}</Typography>)}
