...
const ListShares = (props) => {
    const {color, coupons, invitation, isLoading, countCoupons, organization} = props;
    ...
    return (
        <View style={styles.root}>
            ...
            <TouchableOpacity style={styles.header} onPress={handleToAllCoupons}>
                <Text style={styles.headerTitle}>{allTranslations(localization.companyPagesPromotions)} <Text style={{ color: props.color }}>{ countCoupons }</Text></Text>
