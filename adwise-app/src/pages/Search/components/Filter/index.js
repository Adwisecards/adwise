...
const Filter = (props) => {
    const { filter, view, categories, onChange, onChangeOpen, onChangeView } = props;
    ...
    const handleOnChangeView = () => {
        onChangeView(Boolean(view === 'list') ? 'map' : 'list');
    }
    ...
    return (
        <View style={styles.root}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.buttonMap} onPress={handleOnChangeView}>
                    <Icon
                        name={Boolean(view === 'list') ? 'map-marker-alt' : 'bars'}
                        type="FontAwesome5"
                        style={styles.buttonMapIcon}
                    />
                </TouchableOpacity>
            </View>
