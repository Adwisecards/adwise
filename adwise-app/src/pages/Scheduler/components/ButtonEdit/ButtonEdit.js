    ...
    return (
        <Animated.View style={styles.containerButtonEditAbsolute}>
            <TouchableOpacity
                ...
                onPress={onPress}
            >
                <Icon name={'plus'} style={styles.buttonEditAbsolute_Icon} type={'MaterialCommunityIcons'}/>
                <Text style={styles.buttonEditAbsolute_Text}>{allTranslations(localization.schedulerButtonCreate)}</Text>
            </TouchableOpacity>
        </Animated.View>
    )
}
