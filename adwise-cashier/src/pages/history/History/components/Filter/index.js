...
const Filter = (props) => {
    ...
    const isEmpty = Boolean(filter.type.length <= 0 && !filter.dateFrom && !filter.dateTo && !filter.refCode);
                    ...
                    isEmpty ? (
                        ...
                        <View style={[styles.viewEmpty, {height: 'auto'}]}>
                            <View style={{flex: 1}}>
                                ...
                                {
                                    Boolean(filter.refCode) && (
                                        <View style={styles.selectedLine}>
                                            <Text style={[styles.selectedLineText, {marginRight: 6}]}>Код покупки</Text>
                                            <Text style={[styles.selectedDate]}>
                                                {filter.refCode}
                                            </Text>
                                        </View>
                ...
                isOpen && (
                    <View style={styles.dropDown}>
                        ...
                        <View style={[styles.dropDownSection, {marginTop: 24}]}>
                            ...
                            <Text style={styles.dropDownSectionTitle}>Дополнительно</Text>

                            <TextInputMask
                                value={filter.refCode}
                                onChangeText={(code) => handleOnChange({value: code, name: 'refCode'})}
