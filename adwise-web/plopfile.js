    ...
    actions(data) {
      const actions = [
        ...
        },
        {
          type: 'add',
          path:
            'src/views/{{properCase name}}/{{properCase name}}Container.js',
          templateFile: 'generators/page/PageViewContainer.js.hbs'
        },
        {
          type: 'add',
          path:
            'src/views/{{properCase name}}/components/index.js',
      ...
      if (data.type === 'statefull') {
        actions.push({
          type: 'add',
          path: 'src/views/{{properCase name}}/{{properCase name}}State.js',
